	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'options',
				options: [
					{ name: 'Akbar', value: '18c4043e' },
					{ name: 'Alex', value: '80b9095f' },
					{ name: 'Aman', value: '5daa73d5' },
					{ name: 'Cathy', value: '17de03e4' },
					{ name: 'Chloe', value: '45e3f732' },
					{ name: 'Clara', value: '7e95996' },
					{ name: 'Jason', value: '05a001fc' },
					{ name: 'Jennifer', value: '0de70332' },
					{ name: 'Jessica', value: '21ef04ad' },
					{ name: 'Johnny', value: '1fa504ff' },
					{ name: 'Lisa', value: '665a1170' },
					{ name: 'Lucy', value: 'c5b563de' },
					{ name: 'Mike', value: '03ae0187' },
					{ name: 'Misha', value: '05b401f3' },
					{ name: 'Priya', value: '1e4ea106' },
					{ name: 'Sameer', value: '60a0926a' },
					{ name: 'Sofia', value: '1928040f' },
				],
				default: '665a1170',
				displayOptions: {
			...
			},
			{
				...
				options: [
					...
					{ name: 'Evan', value: 'TWutjvRaJqAX89preB4e' },
					{ name: 'Hope', value: 'uYXf8XasLslADfZ2MB4u' },
					{ name: 'Jack', value: 'bIHbv24MWmeRgasZH58o' },
					{ name: 'Jess', value: 'ys3XeJJA4ArWMhRpcX1D' },
					{ name: 'Laura', value: 'FGLJyeekUzxl8M3CTG9M' },
					{ name: 'Laura Peeters', value: 'gC9jy9VUxaXAswovchvQ' },
					{ name: 'Lauren', value: 'dGku3wKAuA20JBmsCsXv' },
					{ name: 'Lisa', value: 'FGY2WhTYpPnrIDTdsKH5' },
					{ name: 'Loral', value: 'bP6y87KyX5lwNEi7xOkX' },
					{ name: 'Luca', value: '4JVOFy4SLQs9my0OLhEw' },
					{ name: 'Priya', value: 'ZUrEGyu8GFMwnHbvLhv2' },
					{ name: 'Sameer', value: 'SV61h9yhBg4i91KIBwdz' },
					{ name: 'Sean', value: 'ztnpYzQJyWffPj1VC5Uw' },
				],
